...
- ```scan()```: para definir un vector desde pantalla o desde url o nombre de fichero
...
## COSAS de VECTORES
- valores NA para remover en un vector 
-sum(c, na.rm = TRUE)
...
ES COMO PARA MOSTRAR LOS VALORES ÚNICOS
